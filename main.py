...
class DataLoaderModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        if stage == 'fit':
            ...
            example_loader = get_example_loader(self.train_path, self.vocab_size, self.vocab_path, self.max_article_len,
                                                self.max_title_len, self.use_pointer,
                                                test_mode=False, test_num=10000)
            self.train_dataset = covert_loader_to_dataset(example_loader)
            self.train_sampler = RandomSampler(self.train_dataset)

            assert os.path.isfile(self.valid_path)
            example_loader = get_example_loader(self.valid_path, self.vocab_size, self.vocab_path, self.max_article_len,
                                                self.max_title_len, self.use_pointer,
                                                test_mode=False, test_num=1000)
        ...
        if stage == 'test':
            ...
            example_loader = get_example_loader(self.test_path, self.vocab_size, self.vocab_path, self.max_article_len,
                                                self.max_title_len, self.use_pointer,
                                                test_mode=False, test_num=1000)
...
def main():
    ...
    parser.add_argument("-train_path", type=str,
                        default="/home/disk2/lyj2019/workspace/tianchi/datasets/QuestionGenerationTask/train.csv")
    parser.add_argument("-valid_path", type=str,
                        default="/home/disk2/lyj2019/workspace/tianchi/datasets/QuestionGenerationTask/valid.csv")
    parser.add_argument("-test_path", type=str,
                        default="/home/disk2/lyj2019/workspace/tianchi/datasets/QuestionGenerationTask/test.csv")
    parser.add_argument("-vocab_path", type=str,
                        default="/home/disk2/lyj2019/workspace/tianchi/datasets/QuestionGenerationTask/vocab")
    parser.add_argument("-save_mode", type=str, default="best")
    parser.add_argument("-load_model", type=str, default=None)
    parser.add_argument("-result_dir", type=str,
                        default="/home/disk2/lyj2019/workspace/tianchi/PGN_TR/result/pred.txt")
    ...
    parser.add_argument("-max_article_len", type=int, default=500)
    parser.add_argument("-max_title_len", type=int, default=100)
    parser.add_argument("-min_title_len", type=int, default=5)
    ...
    parser.add_argument("-tgt_emb_proj_weight_sharing", action="store_true")
    parser.add_argument("-emb_src_tgt_weight_sharing", action="store_true")
    parser.add_argument("-smoothing", action="store_true")
    parser.add_argument("-use_transformer_block", type=bool, default=True)
